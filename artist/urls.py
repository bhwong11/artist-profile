...
urlpatterns = [
    ...
    path('profile/<int:pk>/',views.ProfileShowView.as_view(),name='profile_show'),
    path('profile/<int:pk>/update',views.ProfileUpateView.as_view(),name='profile_update'),
    ...
    path('randomfmacode/',views.ChangeFMACode.as_view(),name="change_fma_code"),
